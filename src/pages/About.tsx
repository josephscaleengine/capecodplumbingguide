...
import { Droplets, Heart, MapPin, ExternalLink, Shield, Users, BookOpen } from 'lucide-react';
            ...
            <div className="max-w-4xl mx-auto">
              <div className="bg-card rounded-2xl p-8 md:p-12 shadow-card">
                <div className="flex items-start gap-6">
                  <div className="hidden md:flex w-16 h-16 rounded-xl bg-gradient-ocean items-center justify-center flex-shrink-0">
